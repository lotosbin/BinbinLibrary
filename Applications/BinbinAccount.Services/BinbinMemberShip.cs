...
namespace BinbinAccount.Services
{
    public class BinbinMembership
    {
        ...
        public static BinbinMembershipUser CreateUser(string username, string password)
        {
            return CreateUser(username, password, null);
        }


        public static BinbinMembershipUser CreateUser(string username, string password, string email)
        {
            MembershipCreateStatus status;
            BinbinMembershipUser u = CreateUser(username, password, email, null, null, true, out status);
            if (u == null)
        ...
        public static BinbinMembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer, bool isApproved, out MembershipCreateStatus status)
        {
            return CreateUser(username, password, email, passwordQuestion, passwordAnswer, isApproved, null, out status);
        }

        public static BinbinMembershipUser CreateUser(string username, string password, string email, string passwordQuestion, string passwordAnswer,
                                                 bool isApproved, object providerUserKey, out MembershipCreateStatus status)
        {
            if (!BinbinSecUtility.ValidateParameter(ref username, true, true, true, 0))
            {
                status = MembershipCreateStatus.InvalidUserName;
                return null;
            }

            if (!BinbinSecUtility.ValidatePasswordParameter(ref password, 0))
            {
            ...
            if (!BinbinSecUtility.ValidateParameter(ref email, false, false, false, 0))
            {
                status = MembershipCreateStatus.InvalidEmail;
                return null;
            }

            if (!BinbinSecUtility.ValidateParameter(ref passwordQuestion, false, true, false, 0))
            {
                status = MembershipCreateStatus.InvalidQuestion;
                return null;
            }

            if (!BinbinSecUtility.ValidateParameter(ref passwordAnswer, false, true, false, 0))
            {
                status = MembershipCreateStatus.InvalidAnswer;
                return null;
            }

            return BinbinProvider.CreateUser(username, password, email, passwordQuestion, passwordAnswer, isApproved, providerUserKey, out status);
        }


        public static bool ValidateUser(string username, string password)
        {
            return BinbinProvider.ValidateUser(username, password);
            /* 
            if (retVal) { 
        ...
        //{
        //    System.Web.Util.SecUtility.CheckParameter(ref username, true, false, true, 0, "username");
        ...
        //{
        //    System.Web.Util.SecUtility.CheckParameter(ref emailToMatch,
        //                               false,
        //                               false,
        //                               false,
        //                               0,
        ...
        //{
        //    System.Web.Util.SecUtility.CheckParameter(ref username, true, true, true, 0, "username");
        ...
        //{
        //    System.Web.Util.SecUtility.CheckParameter(ref usernameToMatch,
        //                               true,
        //                               true,
        //                               false,
        //                               0,
